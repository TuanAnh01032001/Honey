      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-amber-800">🍯 Honey Life</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-black- hover:text-amber-400 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-black-">info@honeylife.vn</span>
              </div>
        ...
        <div className="border-t border-black-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-black-400 text-sm">
              © 2025, Honey For Life / Powered by Shopify
            </p>
